...
import (
	...
	"github.com/imdevlab/tracing/tracing/service"
	"go.uber.org/zap"
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.vgo.yaml)")
