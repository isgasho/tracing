...
func (p TFJvmGcType) String() string {
	switch p {
	case TFJvmGcType_UNKNOWN:
		return "UNKNOWN"
	case TFJvmGcType_SERIAL:
		return "SERIAL"
	case TFJvmGcType_PARALLEL:
		return "PARALLEL"
	case TFJvmGcType_CMS:
		return "CMS"
	case TFJvmGcType_G1:
		return "G1"
	}
...
func TFJvmGcTypeFromString(s string) (TFJvmGcType, error) {
	switch s {
	case "UNKNOWN":
		return TFJvmGcType_UNKNOWN, nil
	case "SERIAL":
		return TFJvmGcType_SERIAL, nil
	case "PARALLEL":
		return TFJvmGcType_PARALLEL, nil
	case "CMS":
		return TFJvmGcType_CMS, nil
	case "G1":
		return TFJvmGcType_G1, nil
	}
...
var TFAgentInfo_Container_DEFAULT bool = false

func (p *TFAgentInfo) GetContainer() bool {
	return p.Container
}
...
func (p *TFAgentInfo) IsSetContainer() bool {
	return p.Container != TFAgentInfo_Container_DEFAULT
}
...
func (p *TFAgentInfo) ReadField40(iprot thrift.TProtocol) error {
...
func (p *TFAgentInfo) writeField40(oprot thrift.TProtocol) (err error) {
	if p.IsSetContainer() {
		if err := oprot.WriteFieldBegin("container", thrift.BOOL, 40); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 40:container: ", p), err)
		}
		if err := oprot.WriteBool(bool(p.Container)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.container (40) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 40:container: ", p), err)
		}
	}
	return err
}
...
//  - MappedCount
//  - MappedMemoryUsed
type TFDirectBuffer struct {
	DirectCount      *int64 `thrift:"directCount,1" db:"directCount" json:"directCount,omitempty"`
	DirectMemoryUsed *int64 `thrift:"directMemoryUsed,2" db:"directMemoryUsed" json:"directMemoryUsed,omitempty"`
	MappedCount      *int64 `thrift:"mappedCount,3" db:"mappedCount" json:"mappedCount,omitempty"`
	MappedMemoryUsed *int64 `thrift:"mappedMemoryUsed,4" db:"mappedMemoryUsed" json:"mappedMemoryUsed,omitempty"`
}

func NewTFDirectBuffer() *TFDirectBuffer {
	return &TFDirectBuffer{}
}

var TFDirectBuffer_DirectCount_DEFAULT int64

func (p *TFDirectBuffer) GetDirectCount() int64 {
	if !p.IsSetDirectCount() {
		return TFDirectBuffer_DirectCount_DEFAULT
	}
	return *p.DirectCount
}

var TFDirectBuffer_DirectMemoryUsed_DEFAULT int64

func (p *TFDirectBuffer) GetDirectMemoryUsed() int64 {
	if !p.IsSetDirectMemoryUsed() {
		return TFDirectBuffer_DirectMemoryUsed_DEFAULT
	}
	return *p.DirectMemoryUsed
}

var TFDirectBuffer_MappedCount_DEFAULT int64

func (p *TFDirectBuffer) GetMappedCount() int64 {
	if !p.IsSetMappedCount() {
		return TFDirectBuffer_MappedCount_DEFAULT
	}
	return *p.MappedCount
}

var TFDirectBuffer_MappedMemoryUsed_DEFAULT int64

func (p *TFDirectBuffer) GetMappedMemoryUsed() int64 {
	if !p.IsSetMappedMemoryUsed() {
		return TFDirectBuffer_MappedMemoryUsed_DEFAULT
	}
	return *p.MappedMemoryUsed
}
func (p *TFDirectBuffer) IsSetDirectCount() bool {
	return p.DirectCount != nil
}

func (p *TFDirectBuffer) IsSetDirectMemoryUsed() bool {
	return p.DirectMemoryUsed != nil
}

func (p *TFDirectBuffer) IsSetMappedCount() bool {
	return p.MappedCount != nil
}

func (p *TFDirectBuffer) IsSetMappedMemoryUsed() bool {
	return p.MappedMemoryUsed != nil
}

func (p *TFDirectBuffer) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *TFDirectBuffer) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return thrift.PrependError("error reading field 1: ", err)
	} else {
		p.DirectCount = &v
...
func (p *TFDirectBuffer) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return thrift.PrependError("error reading field 2: ", err)
	} else {
		p.DirectMemoryUsed = &v
	}
	return nil
}

func (p *TFDirectBuffer) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return thrift.PrependError("error reading field 3: ", err)
	} else {
		p.MappedCount = &v
...
func (p *TFDirectBuffer) ReadField4(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return thrift.PrependError("error reading field 4: ", err)
	} else {
		p.MappedMemoryUsed = &v
	}
	return nil
}

func (p *TFDirectBuffer) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("TFDirectBuffer"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField1(oprot); err != nil {
...
func (p *TFDirectBuffer) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetDirectCount() {
		if err := oprot.WriteFieldBegin("directCount", thrift.I64, 1); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:directCount: ", p), err)
		}
		if err := oprot.WriteI64(int64(*p.DirectCount)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.directCount (1) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 1:directCount: ", p), err)
		}
	}
	return err
}

func (p *TFDirectBuffer) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetDirectMemoryUsed() {
		if err := oprot.WriteFieldBegin("directMemoryUsed", thrift.I64, 2); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:directMemoryUsed: ", p), err)
		}
		if err := oprot.WriteI64(int64(*p.DirectMemoryUsed)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.directMemoryUsed (2) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 2:directMemoryUsed: ", p), err)
		}
	}
	return err
}

func (p *TFDirectBuffer) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetMappedCount() {
		if err := oprot.WriteFieldBegin("mappedCount", thrift.I64, 3); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:mappedCount: ", p), err)
		}
		if err := oprot.WriteI64(int64(*p.MappedCount)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.mappedCount (3) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 3:mappedCount: ", p), err)
		}
	}
	return err
}

func (p *TFDirectBuffer) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetMappedMemoryUsed() {
		if err := oprot.WriteFieldBegin("mappedMemoryUsed", thrift.I64, 4); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:mappedMemoryUsed: ", p), err)
		}
		if err := oprot.WriteI64(int64(*p.MappedMemoryUsed)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.mappedMemoryUsed (4) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 4:mappedMemoryUsed: ", p), err)
		}
	}
	return err
}

func (p *TFDirectBuffer) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TFDirectBuffer(%+v)", *p)
}
...
type TFAgentStat struct {
	...
	// unused fields # 61 to 79
	FileDescriptor *TFFileDescriptor `thrift:"fileDescriptor,80" db:"fileDescriptor" json:"fileDescriptor,omitempty"`
	// unused fields # 81 to 89
	DirectBuffer *TFDirectBuffer `thrift:"directBuffer,90" db:"directBuffer" json:"directBuffer,omitempty"`
...
var TFAgentStat_FileDescriptor_DEFAULT *TFFileDescriptor

func (p *TFAgentStat) GetFileDescriptor() *TFFileDescriptor {
	if !p.IsSetFileDescriptor() {
		return TFAgentStat_FileDescriptor_DEFAULT
	}
	return p.FileDescriptor
}

var TFAgentStat_DirectBuffer_DEFAULT *TFDirectBuffer

func (p *TFAgentStat) GetDirectBuffer() *TFDirectBuffer {
	if !p.IsSetDirectBuffer() {
		return TFAgentStat_DirectBuffer_DEFAULT
	}
	return p.DirectBuffer
}
...
func (p *TFAgentStat) IsSetFileDescriptor() bool {
	return p.FileDescriptor != nil
}

func (p *TFAgentStat) IsSetDirectBuffer() bool {
	return p.DirectBuffer != nil
}
...
func (p *TFAgentStat) ReadField80(iprot thrift.TProtocol) error {
	p.FileDescriptor = &TFFileDescriptor{}
	if err := p.FileDescriptor.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.FileDescriptor), err)
	}
	return nil
}

func (p *TFAgentStat) ReadField90(iprot thrift.TProtocol) error {
	p.DirectBuffer = &TFDirectBuffer{}
	if err := p.DirectBuffer.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.DirectBuffer), err)
	}
	return nil
}
...
func (p *TFAgentStat) writeField80(oprot thrift.TProtocol) (err error) {
	if p.IsSetFileDescriptor() {
		if err := oprot.WriteFieldBegin("fileDescriptor", thrift.STRUCT, 80); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 80:fileDescriptor: ", p), err)
		}
		if err := p.FileDescriptor.Write(oprot); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.FileDescriptor), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 80:fileDescriptor: ", p), err)
		}
	}
	return err
}

func (p *TFAgentStat) writeField90(oprot thrift.TProtocol) (err error) {
	if p.IsSetDirectBuffer() {
		if err := oprot.WriteFieldBegin("directBuffer", thrift.STRUCT, 90); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 90:directBuffer: ", p), err)
		}
		if err := p.DirectBuffer.Write(oprot); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.DirectBuffer), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 90:directBuffer: ", p), err)
		}
	}
	return err
}
...
type TFFileDescriptor struct {
	OpenFileDescriptorCount int64 `thrift:"openFileDescriptorCount,1" db:"openFileDescriptorCount" json:"openFileDescriptorCount"`
}

func NewTFFileDescriptor() *TFFileDescriptor {
	return &TFFileDescriptor{}
}

func (p *TFFileDescriptor) GetOpenFileDescriptorCount() int64 {
	return p.OpenFileDescriptorCount
}
func (p *TFFileDescriptor) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *TFFileDescriptor) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return thrift.PrependError("error reading field 1: ", err)
	} else {
		p.OpenFileDescriptorCount = v
	}
	return nil
}

func (p *TFFileDescriptor) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("TFFileDescriptor"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField1(oprot); err != nil {
...
func (p *TFFileDescriptor) writeField1(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("openFileDescriptorCount", thrift.I64, 1); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:openFileDescriptorCount: ", p), err)
	}
	if err := oprot.WriteI64(int64(p.OpenFileDescriptorCount)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.openFileDescriptorCount (1) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 1:openFileDescriptorCount: ", p), err)
	}
	return err
}

func (p *TFFileDescriptor) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TFFileDescriptor(%+v)", *p)
}
